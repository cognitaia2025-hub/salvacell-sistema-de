...
import { generateFolio, calculateClientTier } from '@/lib/mock-data'
...
export function NewOrderDialog({ onClose, onSave }: NewOrderDialogProps) {
  ...
  const filteredClients: Client[] = []  // No mock clients, will search from database
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="mt-6">
          <div className="flex gap-2 mb-6">
            ...
            />
            <div
              className={`flex-1 h-2 rounded ${step >= 3 ? 'bg-primary' : 'bg-muted'
                }`}
            />
          </div>
